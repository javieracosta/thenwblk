jQuery(document).ready(function($) {
  ...
  $('#item-content').ready(function(){
    $('header').find('.arrow.back').children('a').attr('href', $('#item-content').find('#nextProduct').attr('href'));
    $('header').find('.arrow.forward').children('a').attr('href', $('#item-content').find('#prevProduct').attr('href'));
  });
  ...
  $('#iosMission').iosSlider({
    navPrevSelector : $('.back button'),
    navNextSelector : $('.forward button'),
