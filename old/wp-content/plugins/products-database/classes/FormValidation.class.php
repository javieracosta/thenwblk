...
class FormValidation {
	...
	public function __construct() {
		...
		$options = get_option( Products_Db::$products_db_options );
	...
	public function get_validation_errors() {
		...
		foreach ( $this->errors as $field => $error ) :
			...
			if ( ! empty( $field ) ) $error_CSS[] = '#'.Products_Db::$css_prefix.$field.' input[type="text"], #'.Products_Db::$css_prefix.$field.' textarea';
	...
	public function get_error_html() {
		...
		foreach ( $this->errors as $field => $error ) :
			...
			$field_atts = Products_Db::get_field_atts( $field );
			...
			if ( $element ) $error_CSS[] = '#'.Products_Db::$css_prefix.$field.' '.$element;
