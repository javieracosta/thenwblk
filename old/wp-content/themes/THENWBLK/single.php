	...
	color:#fff;
		...
		<div id="primary" class="gray-bg">
			<div id="blog-archives">
				...
				<div class="custom-archive"><h2>NWBLK INTERVIEWS</h2>
					<ul class="archive-category">
		...
		<div style="clear:both;"></div>
			...
			<fb:like send="false" layout="button_count" style="top:-4px;" width="450" show_faces="false" colorscheme="light" font="trebuchet ms"></fb:like>
