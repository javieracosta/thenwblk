...
define( 'WPCACHEHOME', '/home/thenwblx/public_html/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('DB_NAME', 'thenwblx_home');

/** MySQL database username */
define('DB_USER', 'thenwblx_master');

/** MySQL database password */
define('DB_PASSWORD', 'missiondispatch1');
